...
namespace InGameAssistant
{
    ...
    {
        private string text = "";
        private string randomNumberText = "The random number will be displayed here";
        ...
        public string Text
        {
            ...
            set
            {
                if (text != value)
                {
                    ...
                    // When text changes, get a new random number
                    UpdateRandomNumber();
                }
            }
        }
        ...
        {
            get => randomNumberText;
            set
            {
                if (randomNumberText != value)
                {
                    randomNumberText = value;
                    OnPropertyChanged(nameof(RandomNumberText));
                }
            }
        }
        ...
        private async void UpdateRandomNumber()
        {
            using (var client = new HttpClient())
            {
                try
                ...
                {
                    RandomNumberText = "Error getting random number";
                }
            }
        }
    }
