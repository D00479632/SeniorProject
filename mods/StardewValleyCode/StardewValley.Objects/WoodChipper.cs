	...
	public class WoodChipper : Object
	{
		...
		public override void draw(SpriteBatch spriteBatch, int x, int y, float alpha = 1f)
		{
			...
			if (depositedItem.Value != null && shakeTimer > 0 && _isAnimatingChip)
			{
				...
				spriteBatch.Draw(itemTexture2, draw_position, itemDraw2.GetSourceRect(), Color.White * alpha, 0f, new Vector2(8f, 8f), 4f * draw_scale, depositedItem.Value.flipped.Value ? SpriteEffects.FlipHorizontally : SpriteEffects.None, draw_layer + 0.00175f);
			}
