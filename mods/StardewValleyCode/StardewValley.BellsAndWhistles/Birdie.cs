	...
	public class Birdie : Critter
	{
		...
		public override bool update(GameTime time, GameLocation environment)
		{
			...
			case 4:
				...
				{
					int delta2 = (flip ? 1 : (-1));
					if (!environment.isCollidingPosition(getBoundingBox(delta2, 0), Game1.viewport, isFarmer: false, 0, glider: false, null, pathfinding: false, projectile: false, ignoreCharacterRequirement: true))
					{
						position.X += delta2;
					}
				}
