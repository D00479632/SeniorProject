...
namespace StardewValley.TerrainFeatures
{
	...
	public class Grass : TerrainFeature
	{
		...
		public override void doCollisionAction(Rectangle positionOfCollider, int speedOfCollision, Vector2 tileLocation, Character who)
		{
			...
			if (who is Farmer && Game1.player.CurrentTool is MeleeWeapon weapon && weapon.isOnSpecial && weapon.type.Value == 0 && Math.Abs(shakeRotation) < 0.001f && performToolAction(Game1.player.CurrentTool, -1, tileLocation))
			{
