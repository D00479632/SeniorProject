...
namespace StardewValley.Menus
{
	public class LevelUpMenu : IClickableMenu
	{
			...
			: base(Game1.uiViewport.Width / 2 - 384, Game1.uiViewport.Height / 2 - 256, 768, 512)
		{
			...
			{
				if (CraftingRecipe.TryParseLevelRequirement(v2.Key, v2.Value, isCooking: false, out var reqSkillNumber2, out var minLevel2) && reqSkillNumber2 == skill && minLevel2 == level)
				{
			...
			{
				if (CraftingRecipe.TryParseLevelRequirement(v.Key, v.Value, isCooking: true, out var reqSkillNumber, out var minLevel) && reqSkillNumber == skill && minLevel == level)
				{
