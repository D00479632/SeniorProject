				...
				if (name != null)
				{
					...
					case 5:
						...
						case 'B':
							...
							{
								Item oldItem5 = Utility.PerformSpecialItemGrabReplacement(Game1.player.Equip((Boots)newItem, Game1.player.boots));
						...
						case 'S':
						{
							...
							Item oldItem3 = Utility.PerformSpecialItemGrabReplacement(Game1.player.Equip((Clothing)newItem, Game1.player.shirtItem));
						...
						case 'P':
						{
							...
							Item oldItem4 = Utility.PerformSpecialItemGrabReplacement(Game1.player.Equip((Clothing)newItem, Game1.player.pantsItem));
					...
					case 3:
						...
						{
							Item oldItem2 = Utility.PerformSpecialItemGrabReplacement(Game1.player.Equip((Hat)newItem, Game1.player.hat));
					...
					case 7:
						{
							if (name == "Trinket" && Game1.player.stats.Get("trinketSlots") != 0 && checkHeldItem((Item i) => i == null || i is Trinket))
							{
