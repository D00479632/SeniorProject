...
namespace StardewValley.Menus
{
	public class ShippingMenu : IClickableMenu
	{
		...
		public int getCategoryIndexForObject(Item item)
		{
			...
			if (item is Object o && (o.preserve.Value.GetValueOrDefault() == Object.PreserveType.SmokedFish || o.preserve.Value.GetValueOrDefault() == Object.PreserveType.AgedRoe || o.preserve.Value.GetValueOrDefault() == Object.PreserveType.Roe))
			{
				return 2;
			}
