		...
		public override void draw(SpriteBatch b)
		{
			...
			else
			{
				...
				else
				{
					...
					if (Game1.stats.Get("BillboardQuestsDone") % 3u == 2 && (acceptQuestButton.visible || !Game1.questOfTheDay.completed.Value))
					{
				...
				bool drawAllStars = Game1.stats.Get("BillboardQuestsDone") % 3u == 0 && Game1.questOfTheDay != null && Game1.questOfTheDay.completed.Value;
