		...
		private void optionButtonClick(string name)
		{
			...
			else if (name != null)
			{
				...
				case 8:
					...
					{
					case 't':
						if (name == "Standard" && (source == Source.NewGame || source == Source.HostNewFarm))
						{
							Game1.whichFarm = 0;
				...
				case 6:
					...
					{
					case 'o':
						if (name == "Forest" && (source == Source.NewGame || source == Source.HostNewFarm))
						{
							Game1.whichFarm = 2;
							Game1.whichModFarm = null;
							Game1.spawnMonstersAtNight = false;
				...
				case 5:
					...
					{
					case 'H':
						if (name == "Hills" && (source == Source.NewGame || source == Source.HostNewFarm))
						{
							Game1.whichFarm = 3;
							Game1.whichModFarm = null;
							Game1.spawnMonstersAtNight = false;
						...
						break;
					case 'B':
						if (name == "Beach" && (source == Source.NewGame || source == Source.HostNewFarm))
						{
							Game1.whichFarm = 6;
							Game1.whichModFarm = null;
							Game1.spawnMonstersAtNight = false;
				...
				case 3:
					...
					{
					case 'C':
						if (name == "Cat" && (source == Source.NewGame || source == Source.HostNewFarm))
						{
							Game1.player.whichPetType = "Cat";
						}
						break;
					case 'D':
						if (name == "Dog" && (source == Source.NewGame || source == Source.HostNewFarm))
						{
					...
					break;
				case 9:
					if (name == "Riverland" && (source == Source.NewGame || source == Source.HostNewFarm))
					{
						Game1.whichFarm = 1;
						Game1.whichModFarm = null;
						Game1.spawnMonstersAtNight = false;
					...
					break;
				case 10:
					if (name == "Wilderness" && (source == Source.NewGame || source == Source.HostNewFarm))
					{
						Game1.whichFarm = 4;
						Game1.whichModFarm = null;
					...
					break;
				case 12:
					if (name == "Four Corners" && (source == Source.NewGame || source == Source.HostNewFarm))
					{
						Game1.whichFarm = 5;
						Game1.whichModFarm = null;
						Game1.spawnMonstersAtNight = false;
