		...
		public override void update(GameTime time)
		{
			...
			if (clint.currentFrame == 11 && frame != 11)
			{
				...
				if (geodeSpot.item != null)
				{
					...
					if (!(geodeSpot.item.QualifiedItemId == "(O)275") && (!(geodeTreasure is Object mineral) || !(mineral.Type == "Minerals")) && geodeTreasure is Object artifact && artifact.Type == "Arch" && !Game1.player.hasOrWillReceiveMail("artifactFound"))
					{
