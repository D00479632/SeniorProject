			...
			if (i != null)
			{
				...
				if (qualifiedItemId != null)
				{
					...
					if (length == 6)
					{
						...
						{
						case '0':
							if (!(qualifiedItemId == "(O)820") || office.piecesDonated[5])
							{
								break;
							}
							return true;
						case '1':
							if (!(qualifiedItemId == "(O)821") || office.piecesDonated[4])
							{
								break;
							}
							return true;
						case '2':
							if (!(qualifiedItemId == "(O)822") || office.piecesDonated[3])
							{
								break;
							}
							return true;
						case '3':
							if (!(qualifiedItemId == "(O)823") || (office.piecesDonated[0] && office.piecesDonated[2]))
							{
								break;
							}
							return true;
						case '4':
							if (!(qualifiedItemId == "(O)824") || office.piecesDonated[1])
							{
								break;
							}
							return true;
						case '5':
							if (!(qualifiedItemId == "(O)825") || office.piecesDonated[8])
							{
								break;
							}
							return true;
						case '6':
							if (!(qualifiedItemId == "(O)826") || (office.piecesDonated[7] && office.piecesDonated[6]))
							{
								break;
							}
							return true;
						case '7':
							if (!(qualifiedItemId == "(O)827") || office.piecesDonated[9])
							{
								break;
							}
							return true;
						case '8':
							if (!(qualifiedItemId == "(O)828") || office.piecesDonated[10])
							{
								break;
							}
							return true;
