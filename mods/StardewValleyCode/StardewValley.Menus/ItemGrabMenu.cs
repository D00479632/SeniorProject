...
namespace StardewValley.Menus
{
	public class ItemGrabMenu : MenuWithInventory
	{
		...
		public override void snapToDefaultClickableComponent()
		{
			...
			else if (source == 1 && sourceItem is Chest chest && chest.SpecialChestType == Chest.SpecialChestTypes.MiniShippingBin)
			{
				currentlySnappedComponent = getComponentWithID(0);
			}
			else
		...
		public static void organizeItemsInList(IList<Item> items)
		{
			...
			for (int k = 0; k < copy.Count; k++)
			{
				...
				for (int l = k + 1; l < copy.Count; l++)
				{
					Item other_item = copy[l];
