...
namespace StardewValley.Locations
{
	public class Railroad : GameLocation
	{
		...
		internal void ResetTrainForNewDay()
		{
			...
			trainTime = -1;
			Random random = Utility.CreateRandom(Game1.stats.DaysPlayed, Game1.uniqueIDForThisGame / 2uL);
			Random rngTomorrow = Utility.CreateRandom(Game1.stats.DaysPlayed + 1, Game1.uniqueIDForThisGame / 2uL);
