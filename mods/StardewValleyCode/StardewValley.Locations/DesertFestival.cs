			...
			if (action != null)
			{
				...
				case 14:
					...
					case 'R':
					{
						...
						{
							if (raceGuesses.TryGetValue(Game1.player.UniqueMultiplayerID, out var guessedRacer2) && currentRaceState.Value == RaceState.Go)
							{
						...
						else if (nextRaceGuesses.TryGetValue(Game1.player.UniqueMultiplayerID, out guessedRacer))
						{
