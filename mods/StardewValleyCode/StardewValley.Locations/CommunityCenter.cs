	...
	public class CommunityCenter : GameLocation
	{
		...
		public void addJunimoNote(int area)
		{
			...
			if (!position.Equals(Vector2.Zero))
			{
				...
				currentLightSources.Add(new LightSource(defaultInterpolatedStringHandler.ToStringAndClear(), 4, new Vector2(position.X * 64, position.Y * 64), 1f, LightSource.LightContext.None, 0L, base.NameOrUniqueName));
		...
		public void loadArea(int area, bool showEffects = true)
		{
			...
			defaultInterpolatedStringHandler.AppendFormatted(area);
			ApplyMapOverride(refurbishedMap, defaultInterpolatedStringHandler.ToStringAndClear(), areaToRefurbish, areaToRefurbish);
			...
			foreach (Point tile in areaToRefurbish.GetPoints())
			{
				...
				if (fromTile != null && fromTile.TileIndex == 8)
				{
					...
					currentLightSources.Add(new LightSource(defaultInterpolatedStringHandler.ToStringAndClear(), 4, new Vector2(x * 64, y * 64), 2f, LightSource.LightContext.None, 0L, base.NameOrUniqueName));
				}
		...
		public static StaticTile[] getJunimoNoteTileFrames(int area, Map map)
		{
			...
			if (area == 5)
			{
				...
				{
					new StaticTile(layer2, tileSheet, BlendMode.Alpha, 1741),
					new StaticTile(layer2, tileSheet, BlendMode.Alpha, 1741),
					new StaticTile(layer2, tileSheet, BlendMode.Alpha, 1741),
					new StaticTile(layer2, tileSheet, BlendMode.Alpha, 1741),
					new StaticTile(layer2, tileSheet, BlendMode.Alpha, 1741),
					...
					new StaticTile(layer2, tileSheet, BlendMode.Alpha, 1741),
					new StaticTile(layer2, tileSheet, BlendMode.Alpha, 1741),
					new StaticTile(layer2, tileSheet, BlendMode.Alpha, 1773),
					new StaticTile(layer2, tileSheet, BlendMode.Alpha, 1805),
					new StaticTile(layer2, tileSheet, BlendMode.Alpha, 1805),
					new StaticTile(layer2, tileSheet, BlendMode.Alpha, 1773)
				};
			}
			...
			{
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1833),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1833),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1833),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1833),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1833),
				...
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1833),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1833),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1832),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1824),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1825),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1826),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1827),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1828),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1829),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1830),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1831),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1832),
				new StaticTile(layer, tileSheet, BlendMode.Alpha, 1833)
			};
		}
