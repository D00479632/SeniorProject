...
namespace StardewValley
{
	public class Fence : Object
	{
		...
		{
			switch (obsolete_whichType.GetValueOrDefault(1))
			{
			case 2:
				base.ItemId = "323";
				break;
		...
		public virtual void toggleGate(bool open, bool is_toggling_counterpart = false, Farmer who = null)
		{
			...
			case 100:
			{
				...
				if (location.objects.TryGetValue(neighborTile4, out var neighbor4) && neighbor4 is Fence fence4 && fence4.isGate.Value && fence4.getDrawSum() == 10)
				{
			...
			case 10:
			{
				...
				if (location.objects.TryGetValue(neighborTile3, out var neighbor3) && neighbor3 is Fence fence3 && fence3.isGate.Value && fence3.getDrawSum() == 100)
				{
			...
			case 1000:
			{
				...
				if (location.objects.TryGetValue(neighborTile2, out var neighbor2) && neighbor2 is Fence fence2 && fence2.isGate.Value && fence2.getDrawSum() == 500)
				{
				...
				if (!isGate.Value)
				{
					...
					if (drawSum == 1500 || drawSum == 110 || drawSum == 1000 || drawSum == 10 || drawSum == 100 || drawSum == 500)
					{
						...
						case 10:
							...
							{
								int neighborSum3 = rightFence.getDrawSum();
								if (neighborSum3 != 100 && neighborSum3 != 110)
								{
									return false;
								}
							}
						...
						case 1000:
							...
							{
								int neighborSum2 = downFence.getDrawSum();
								if (neighborSum2 != 500 && neighborSum2 != 1500)
								{
									return false;
								}
							}
		...
		public override void draw(SpriteBatch b, int x, int y, float alpha = 1f)
		{
			...
			if (health.Value > 1f || repairQueued.Value)
			{
				...
				if (isGate.Value)
				{
					...
					{
					case 10:
						b.Draw(fenceTexture.Value, Game1.GlobalToLocal(Game1.viewport, offset2 + new Vector2(x * 64 - 16, y * 64 - 128)), new Rectangle((gatePosition.Value == 88) ? 24 : 0, 192, 24, 48), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, (float)(y * 64 + 32 + 1) / 10000f);
						return;
					case 100:
						b.Draw(fenceTexture.Value, Game1.GlobalToLocal(Game1.viewport, offset2 + new Vector2(x * 64 - 16, y * 64 - 128)), new Rectangle((gatePosition.Value == 88) ? 24 : 0, 240, 24, 48), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, (float)(y * 64 + 32 + 1) / 10000f);
						return;
					case 1000:
						b.Draw(fenceTexture.Value, Game1.GlobalToLocal(Game1.viewport, offset2 + new Vector2(x * 64 + 20, y * 64 - 64 - 20)), new Rectangle((gatePosition.Value == 88) ? 24 : 0, 288, 24, 32), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, (float)(y * 64 - 32 + 2) / 10000f);
						return;
					case 500:
						b.Draw(fenceTexture.Value, Game1.GlobalToLocal(Game1.viewport, offset2 + new Vector2(x * 64 + 20, y * 64 - 64 - 20)), new Rectangle((gatePosition.Value == 88) ? 24 : 0, 320, 24, 32), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, (float)(y * 64 + 96 - 1) / 10000f);
						return;
					case 110:
						b.Draw(fenceTexture.Value, Game1.GlobalToLocal(Game1.viewport, offset2 + new Vector2(x * 64 - 16, y * 64 - 64)), new Rectangle((gatePosition.Value == 88) ? 24 : 0, 128, 24, 32), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, (float)(y * 64 + 32 + 1) / 10000f);
						return;
					case 1500:
						b.Draw(fenceTexture.Value, Game1.GlobalToLocal(Game1.viewport, offset2 + new Vector2(x * 64 + 20, y * 64 - 64 - 20)), new Rectangle((gatePosition.Value == 88) ? 16 : 0, 160, 16, 16), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, (float)(y * 64 - 32 + 2) / 10000f);
						b.Draw(fenceTexture.Value, Game1.GlobalToLocal(Game1.viewport, offset2 + new Vector2(x * 64 + 20, y * 64 - 64 + 44)), new Rectangle((gatePosition.Value == 88) ? 16 : 0, 176, 16, 16), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, (float)(y * 64 + 96 - 1) / 10000f);
						return;
					}
