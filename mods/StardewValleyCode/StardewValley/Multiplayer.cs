...
namespace StardewValley
{
	public class Multiplayer
	{
		...
		protected virtual void _receivePassoutRequest(Farmer farmer)
		{
			...
			if (flag.HasValue && flag.GetValueOrDefault() && lastSleepLocation.GetLocationContextId() == farmer.currentLocation.GetLocationContextId())
			{
			...
			if (wakeUpLocations != null)
			{
				foreach (ReviveLocation wakeUpLocation in wakeUpLocations)
				{
					...
					{
						if (item is BedFurniture bed && bed.bedType != BedFurniture.BedType.Child)
						{
