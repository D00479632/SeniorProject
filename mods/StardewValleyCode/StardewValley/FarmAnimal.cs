...
namespace StardewValley
{
	public class FarmAnimal : Character
	{
		...
		public void dayUpdate(GameLocation environment)
		{
			...
			bool produceToday = daysSinceLastLay.Value >= ((data != null) ? new int?(data.DaysToProduce - produceSpeedBonus) : null) && r.NextDouble() < (double)fullness.Value / 200.0 && r.NextDouble() < (double)happiness.Value / 70.0;
			string whichProduce;
