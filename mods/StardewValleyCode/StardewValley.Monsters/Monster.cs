...
namespace StardewValley.Monsters
{
	...
	public class Monster : NPC
	{
		...
		public virtual void InitializeForLocation(GameLocation location)
		{
			...
			if (location is MineShaft mineShaft && mineShaft.mineLevel > 120 && !mineShaft.isSideBranch())
			{
		...
		public override void MovePosition(GameTime time, xTile.Dimensions.Rectangle viewport, GameLocation currentLocation)
		{
			...
			if (moveUp)
			{
				...
				else
				{
					...
					tmp2.Width /= 4;
					bool leftCorner = currentLocation.isCollidingPosition(tmp2, viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this);
					tmp2.X += tmp2.Width * 3;
					bool rightCorner = currentLocation.isCollidingPosition(tmp2, viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this);
			...
			else if (moveLeft)
			{
				...
				else
				{
					...
					tmp.Height /= 4;
					bool topCorner = currentLocation.isCollidingPosition(tmp, viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this);
					tmp.Y += tmp.Height * 3;
					bool bottomCorner = currentLocation.isCollidingPosition(tmp, viewport, isFarmer: false, DamageToFarmer, isGlider.Value, this);
