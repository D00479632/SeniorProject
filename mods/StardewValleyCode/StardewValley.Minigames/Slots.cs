	...
	public class Slots : IMinigame
	{
		...
		public void draw(SpriteBatch b)
		{
			...
			for (int l = 0; l < 8; l++)
			{
				...
				b.Draw(Game1.objectSpriteSheet, basePos + new Vector2(8f, 8 + (l + 2) * 68), Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, getIconIndex(which), 16, 16), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.99f);
				b.Draw(Game1.objectSpriteSheet, basePos + new Vector2(76f, 8 + (l + 2) * 68), Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, getIconIndex(which), 16, 16), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.99f);
				b.Draw(Game1.objectSpriteSheet, basePos + new Vector2(144f, 8 + (l + 2) * 68), Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, getIconIndex(which), 16, 16), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.99f);
				int payout = 0;
				switch (l)
				{
				case 0:
				...
				SpriteText.drawString(b, "x" + payout, (int)basePos.X + 192 + 16, (int)basePos.Y + (l + 2) * 68 + 24, 9999, -1, 99999, 1f, 0.88f, junimoText: false, -1, "", SpriteText.color_White);
			}
			...
			for (int j = 0; j < 17; j++)
			{
				IClickableMenu.drawTextureBox(b, Game1.mouseCursors, new Rectangle(147, 472, 3, 3), (int)basePos.X - 640 + 8, (int)basePos.Y + j * 4 * 3 + 12, (int)(608f - (float)(j * 64) * 1.2f + (float)(j * j * 4) * 0.7f), 4, new Color(j * 25, (j > 8) ? (j * 10) : 0, 255 - j * 25), 4f, drawShadow: false);
			}
