...
namespace StardewValley.Events
{
	public class WorldChangeEvent : BaseFarmEvent
	{
		...
		public void resetForPlayerEntry(Point targetTile)
		{
			...
			defaultInterpolatedStringHandler.AppendFormatted(whichEvent.Value);
			...
			case 15:
			{
				...
				{
					location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Rectangle(184, 104, 14, 15), new Vector2(39 + j % 3, 34.1f + (float)(j / 3) * 0.5f) * 64f, flipped: false, 0f, Color.White)
					{
						animationLength = 1,
						interval = 700f,
						totalNumberOfLoops = 999,
			...
			case 14:
			{
				...
				for (int l = 0; l < 20; l++)
				{
					...
					TemporaryAnimatedSprite parrot2 = new TemporaryAnimatedSprite("LooseSprites\\parrots", new Rectangle(48 + Game1.random.Next(2) * 72, Game1.random.Next(2) * 48, 24, 24), start_point2, flipped: false, 0f, Color.White)
					{
