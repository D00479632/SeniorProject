...
namespace StardewValley.Events
{
	public class PlayerCoupleBirthingEvent : BaseFarmEvent
	{
		...
		private FarmHouse chooseHome()
		{
			...
			{
				if (Game1.getLocationFromName(parent.homeLocation.Value) is FarmHouse home2 && home2 == parent.currentLocation && isSuitableHome(home2))
				{
					return home2;
				}
			}
			...
			{
				if (Game1.getLocationFromName(item.homeLocation.Value) is FarmHouse home && isSuitableHome(home))
				{
					return home;
				}
			}
