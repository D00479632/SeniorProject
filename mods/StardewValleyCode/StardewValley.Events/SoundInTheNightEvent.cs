	...
	public class SoundInTheNightEvent : BaseFarmEvent
	{
		...
		public override bool setUp()
		{
			...
			case 1:
			{
				...
				targetLocation = new Vector2(r.Next(5, backLayer2.LayerWidth - 20), r.Next(5, backLayer2.LayerHeight - 4));
			...
			case 3:
			{
				...
				while (attempts2 > 0)
				{
					targetLocation = new Vector2(r.Next(5, backLayer3.LayerWidth - 4), r.Next(5, backLayer3.LayerHeight - 4));
					if (f.CanItemBePlacedHere(targetLocation))
					{
						break;
					}
