...
namespace StardewValley.Buildings
{
	public class FishPond : Building
	{
		...
		public Item GetFishProduce(Random random = null)
		{
			...
			{
				FishPondReward data2 = selectedOutput;
				...
				defaultInterpolatedStringHandler.AppendFormatted(fishType.Value);
				...
				item = ItemQueryResolver.TryResolveRandomItem(data2, new ItemQueryContext(location, null, null, defaultInterpolatedStringHandler.ToStringAndClear()), avoidRepeat: false, null, (string id) => (!(ItemRegistry.QualifyItemId(selectedOutput.ItemId) == "(O)812")) ? id : ("FLAVORED_ITEM Roe " + fish.QualifiedItemId), fish);
			}
			if (item != null)
			{
		...
		public override void draw(SpriteBatch b)
		{
			...
			{
				for (int l = 0; l < currentOccupants.Value; l++)
				{
