			...
			else if (isFishing)
			{
				...
				if (timeUntilFishingBite != -1f)
				{
					...
					if (fishingBiteAccumulator > timeUntilFishingBite)
					{
						...
						Game1.screenOverlayTempSprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(395, 497, 3, 8), new Vector2(playerPixel2.X - Game1.viewport.X, playerPixel2.Y - 128 - 8 - Game1.viewport.Y), flipped: false, 0.02f, Color.White)
						{
							scale = 5f,
							scaleChange = -0.01f,
